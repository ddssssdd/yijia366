...
-(void)initData{
    ...
    id items=@[
               [[NSMutableDictionary alloc] initWithDictionary:@{@"key" :@"name",@"label":@"姓名：",@"default":@"",@"placeholder":@"",@"ispassword":@"no",@"cell":@"EditTextCell",@"value":self.name }],
               [[NSMutableDictionary alloc] initWithDictionary:@{@"key" :@"car_type",@"label":@"准驾车型：",@"default":@"",@"placeholder":@"",@"ispassword":@"no",@"cell":@"ChooseNextCell",@"value":self.car_type }],
